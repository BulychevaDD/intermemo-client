...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({
    ...
    this.instance = axios.create({
      ...axiosConfig,
      baseURL: axiosConfig.baseURL || '/api/public/users',
    });
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request POST:/login
   */
  login = (data: AuthenticationParameters, params: RequestParams = {}) =>
   ...
   */
  register = (data: RegisterParameters, params: RequestParams = {}) =>
    this.request<User, any>({
      path: `/register`,
      method: 'POST',
      body: data,
